...
/**
 * This servlet is used for creation of a CountryLanguage Record
 * @author Tejal Gajare
 */
@WebServlet(name = "NewCountryLangRecord", urlPatterns = {"/NewCountryLangRecord"})
public class NewCountryLangRecord extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(NewCountryLangRecord.class.getName());
    @Resource
    Validator validator;
    @EJB
    RecordDAO recordDAO;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/CountryLanguageRecords/newCountryLangForm.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (violations.isEmpty()) {
            if (recordDAO.createCountryLang(c)) {
