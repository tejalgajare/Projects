...
/**
 * This servlet is used for creation of a City Record
 * @author Tejal Gajare
 */
@WebServlet(name = "NewCityRecord", urlPatterns = {"/NewCityRecord"})
public class NewCityRecord extends HttpServlet {

  private static final Logger LOG = Logger.getLogger(NewCityRecord.class.getName());
    @Resource
    Validator validator;
    @EJB
    RecordDAO recordDAO;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       request.getRequestDispatcher("/WEB-INF/CityRecords/newCityForm.jsp").forward(request, response);
    }
