...
public class DatabasePopulator {
    ...
    private void populateDatabase() {
        ...
        Designer designer1 = new Designer("Guccio", "Gucci","tgajare@hawk.iit.edu");
        Designer designer2 = new Designer("Giorgio", "Armani","tgajare@hawk.iit.edu");
        Designer designer3 = new Designer("Calvin", "Klein","tgajare@hawk.iit.edu");
        Designer designer4 = new Designer("Christian", "Dior","tgajare@hawk.iit.edu");
        Designer designer5 = new Designer("Blair", "Waldorf","tgajare@hawk.iit.edu");
        Designer designer6 = new Designer("Heidi", "Klum" ,"tgajare@hawk.iit.edu");
        ...
        Customer customer1 = new Customer("Tejal", "Gajare", new GregorianCalendar(1988, 5, 23).getTime(), addr1, 7706256116L,"tgajare@hawk.iit.edu");
        Customer customer2 = new Customer("Aditya", "Ghule", new GregorianCalendar(1983, 2, 27).getTime(), addr2, 6784624248L,"tgajare@hawk.iit.edu");
        Customer customer3 = new Customer("Rashmi", "Ghule", new GregorianCalendar(1999, 3, 7).getTime(), addr3, 3125673024L,"tgajare@hawk.iit.edu");
        Customer customer4 = new Customer("Tanmay", "Gajare", new GregorianCalendar(2000, 1, 5).getTime(), addr5, 6457832456L,"tgajare@hawk.iit.edu");
        Customer customer5 = new Customer("Sayali", "Chandak", new GregorianCalendar(2001, 8, 14).getTime(), addr5, 9876546743L,"tgajare@hawk.iit.edu");
        Customer customer6 = new Customer("Abhed", "Kothadia", new GregorianCalendar(2001, 8, 14).getTime(), addr5, 5436787654L,"tgajare@hawk.iit.edu");
