 ...
 */
@WebServlet("/Registered_User_Login")
public class Registered_User_Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			out.println("<form method = \"post\" action= \"Book_Tickets_Registered.jsp\">");
			...
			out.println("</Table><br><br>");
			out.println("<B><I>NOTE : Select either an Attraction or an Itinerary!</I></B><BR><BR>");
			out.println("<input type = \"submit\" value = \"Book Tickets\"/>");
			out.println("<input type = \"reset\" value = \"Clear\"/></BR></BR>");
			out.println("<a href = \"Registered_User_Login.jsp\"><u>HOME</u></a>");
			out.println("</form>");			
