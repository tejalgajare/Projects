 ...
 */
@WebServlet("/Guest_is_Registered")
public class Guest_is_Registered extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			out.println("<a href = \"Guest_Login.jsp\"><u>HOME</u></a>");
			out.println("</form>");			
