 ...
 */
@WebServlet("/Sign_Up_Before_Booking")
public class Sign_Up_Before_Booking extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
		   ...
		   request.getRequestDispatcher("After_Sign_Book_Tickets.jsp").forward(request, response);
